...
class EqptType(models.Model):
    ...
    name = models.CharField(verbose_name="Наименование типа", max_length=252, unique=True)
    mask = models.CharField(verbose_name="Маска серийного номера", max_length=255, unique=True, validators=[MASK_VALIDATOR])
...
class Eqpt(models.Model):
    ...
    eqpt_type = models.ForeignKey(EqptType, related_name="eqpts", on_delete=models.PROTECT)
    serial_number = models.CharField(verbose_name="Серийный номер", max_length=255, unique=True)
